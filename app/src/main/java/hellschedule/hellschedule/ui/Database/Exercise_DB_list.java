...
public class Exercise_DB_list {
    public String Exercise_partial;
    public String Exercise_name;
    public String Exercise_set;
    public Bitmap Exercise_image;
    public String Exercise_youtube;
    public Exercise_DB_list(String Exercise_partial, String Exercise_name, String Exercise_set, Bitmap Exercise_image, String Exercise_youtube){
        this.Exercise_partial=Exercise_partial;
        this.Exercise_name=Exercise_name;
        this.Exercise_set=Exercise_set;
        this.Exercise_image=Exercise_image;
        this.Exercise_youtube=Exercise_youtube;
    }

    public Exercise_DB_list(){ }
    ...
    public String getExercise_youtube(){ return Exercise_youtube; }
    public void setExercise_youtube(String Exercise_youtube){ this.Exercise_youtube = Exercise_youtube; }
