...
public class BMI2_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter_BMI(getActivity().getApplicationContext(), database.get_BMI2_List());
    ...
    public static BMI2_Fragment newInstance() {
        return new BMI2_Fragment();
    }
}
