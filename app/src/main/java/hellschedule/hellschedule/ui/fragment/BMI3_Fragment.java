...
public class BMI3_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter_BMI(getActivity().getApplicationContext(), database.get_BMI3_List());
    ...
    public static BMI3_Fragment newInstance() {
        return new BMI3_Fragment();
    }
}
