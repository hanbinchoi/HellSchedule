...
public class Routine_Fragment_Big extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter(getActivity().getApplicationContext(), database.get_Exercise_List3());
    ...
    public static Routine_Fragment_Big newInstance() {
        return new Routine_Fragment_Big();
    }
}
