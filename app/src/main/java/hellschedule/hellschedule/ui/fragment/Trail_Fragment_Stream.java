...
public class Trail_Fragment_Stream extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter_Trail(getActivity().getApplicationContext(), database.get_Trail_List3());
    ...
    public static Trail_Fragment_Stream newInstance() {
        return new Trail_Fragment_Stream();
    }
}
