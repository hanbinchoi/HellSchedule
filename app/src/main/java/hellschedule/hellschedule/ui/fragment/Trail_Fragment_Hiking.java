...
public class Trail_Fragment_Hiking extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter_Trail(getActivity().getApplicationContext(), database.get_Trail_List2());
    ...
    public static Trail_Fragment_Hiking newInstance() {
        return new Trail_Fragment_Hiking();
    }
}
