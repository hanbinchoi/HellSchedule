...
public class Routine_Fragment_Usual extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter(getActivity().getApplicationContext(), database.get_Exercise_List2());
    ...
    public static Routine_Fragment_Usual newInstance() {
        return new Routine_Fragment_Usual();
    }
}
